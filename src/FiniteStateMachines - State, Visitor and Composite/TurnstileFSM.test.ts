import { ATurnstileState, StatePatternTurnstileFSM, TurnstileState } from "./StatePatternTurnstileFSM";
import { SwitchCaseTurnstileFSM } from "./SwitchCaseTurnstileFSM";
import { TableDrivenTurnstileFSM } from "./TableDrivenTurnstileFSM";
import { TurnstileWithState, Event, State, Action, Turnstile } from "./Turnstile";
...
describe("Multiple TurnstileFSM implementations", () => {
  ...
  `("$TurnstileFSMClass.name .handleEvent()", ({ TurnstileFSMClass, TestHelper }) => {
    describe.each`
